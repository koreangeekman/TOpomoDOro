<template>
  <section class="row align-items-center">
      <div class="col-12 col-md-6 about text-center pb-4">
      ...
      <div class="col-12 col-md-6 text-center">
        <div class="fs-1 socials d-flex p-3">
          ...
          <a href="account.resume" target="_blank"><i class="p-3 mdi mdi-file-account" title="icon for the users' resume"></i></a>
